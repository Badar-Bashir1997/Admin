     ...
     <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              ...
              <div class="tab-pane active" id="tab_1">
                <?php 
                 $query=" SELECT flock_id,Status,Farm_id FROM flock Where Breed_type='Layer'AND Status='ongoing' ";
        ...
        <?php 
              ...
              <div class="tab-pane" id="tab_2">
                ...
                <?php 
                 $query=" SELECT flock_id,Status,Farm_id FROM flock Where Breed_type='Layer'AND Status='Sold' OR Breed_type='Both' ";
                $result1 = mysqli_query($conn, $query);
