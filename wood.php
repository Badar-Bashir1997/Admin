 ...
 if(isset($_REQUEST['BtnSubmit']))
    {
      $fileinfo = PATHINFO($_FILES["image"]["name"]);
        ...
        move_uploaded_file($_FILES["image"]["tmp_name"],"upload/wood/" . $newFilename);
        $location = "upload/wood/" . $newFilename;
        $qnty_of_wood=$_REQUEST['qnty_of_wood'];
        $price=$_REQUEST['price'];
        $ttl_price=$qnty_of_wood*$price;
        ...
        values('Wood','Wood','$qnty_of_wood','$qnty_of_wood','$price','$ttl_price','$txtamount','$txtremaning','$txtbalance','$Status','$e_Date','$location','$vendor')" ;
    ...
    <section class="content">
      ...
      <div class="box box-default">
        <div class="box-header with-border">
          <h3 class="box-title">Purchase Wood</h3>
        </div>
        <!-- /.box-header -->
        <div class="box-body">
          ...
          <div class="row">
            <div class="col-md-6">
              ...
              <div class="form-group">
                ...
                placeholder="Enter Price" class="form-control" id="price" onchange="totalp(this.value)">
              </div>
            </div>
            <!-- /.col -->
            <!-- /.col -->
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Wood Purchase Record</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body" style="overflow-x: scroll;">
              <table id="example"class="table table-striped table-bordered" cellspacing="0" width="100%">
                ...
                <tbody>
                  <?php
                   $query = "SELECT * FROM purchase WHERE purchase.name='Wood' ";
