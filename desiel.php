 ...
 if(isset($_REQUEST['BtnSubmit']))
    {
       $fileinfo = PATHINFO($_FILES["image"]["name"]);
        ...
        move_uploaded_file($_FILES["image"]["tmp_name"],"upload/Diesel/" . $newFilename);
        $location = "upload/Diesel/" . $newFilename;
        $remain=$qnty_of_dsl=$_REQUEST['qnty_of_dsl'];
        $price=$_REQUEST['price'];
        $e_Date=$_REQUEST['d_Date'];
        $Status=$_REQUEST['Status'];
        $ttl_price=$price*$qnty_of_dsl;
        ...
        values('Diesel','Diesel','$qnty_of_dsl','$remain','$price','$ttl_price','$txtamount','$txtremaning','$txtbalance','$Status','$e_Date','$location','$vendor')";
          ...
          <div class="row">
            <div class="col-md-6">
              ...
              <div class="form-group">
                ...
                placeholder="Price per Liter" class="form-control" id="price" onchange="totalp(this.value)">
              </div>
          ...
          <div class="box">
            ...
            <div class="box-body" style="overflow-x: scroll;">
              <table id="example"class="table table-striped table-bordered" cellspacing="0" width="100%">
                ...
                <tbody>
                  <?php
                    $query = "SELECT * FROM purchase WHERE purchase.name='Diesel' ";
