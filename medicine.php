 ...
 if(isset($_REQUEST['BtnSubmit']))
    {
      $fileinfo = PATHINFO($_FILES["image"]["name"]);
        ...
        $Query = "INSERT INTO medicine(medicine_name,qnty,price,m_date,payment_method,image) 
        values('$medicine','$qnty','$price','$e_Date','$Status','$location')" ;
        ...
        <div class="box-body">
          ...
          <div class="row">
            <div class="col-md-6">
              ...
              <div class="form-group">
                <label>Medicine Quentity</label>
               <input type="text" name="qnty_of_mdsn" parsley-trigger="change" required
                placeholder="Quentity" class="form-control" id="qnty_of_mdsn">
              </div>
            </div>
            <!-- /.col -->
            <!-- /.col -->
