 ...
 if(isset($_REQUEST['BtnSubmit']))
    {
     $fileinfo = PATHINFO($_FILES["image"]["name"]);
        ...
        move_uploaded_file($_FILES["image"]["tmp_name"],"upload/Misc/" . $newFilename);
        $location = "upload/Misc/" . $newFilename;
        $name=$_REQUEST['name'];
        $qnty=$_REQUEST['qnty_of_misc'];
       ...
       $vendor=$_REQUEST['vendor'];
        ...
        values('Misc','$name','$qnty','$qnty','$price','$ttl_price','$txtamount','$txtremaning','$txtbalance','$Status','$e_Date','$location','$vendor')" ;
    ...
    <section class="content">
      ...
      <div class="box box-default">
        <div class="box-header with-border">
          <h3 class="box-title">Misc Purchase</h3>
        </div>
        <!-- /.box-header -->
        <div class="box-body">
             ...
             <div class="col-md-6">
              ...
              <div class="form-group">
               ...
               <div class="form-group">
                ...
                placeholder="Enter Price per unit" class="form-control" id="price" onchange="totalp(this.value)">
              </div>
          ...
          <div class="box">
            ...
            <div class="box-body" style="overflow-x: scroll;">
              <table id="example"class="table table-striped table-bordered" cellspacing="0" width="100%">
                ...
                <tbody>
                  <?php
                    $query = "SELECT * FROM purchase WHERE purchase.name='Misc' ";
