 ...
 if(isset($_REQUEST['BtnSubmit']))
    {
      ...
      $Farm=$_REQUEST['Farm'];
        ...
        $q1="SELECT id,remaining,price_per_unit,(SELECT flock_id FROM flock WHERE flock.Flock_name='$Flock1')AS flock_id FROM purchase WHERE remaining>0 AND name='Diesel' AND type='Diesel' ORDER BY id ASC";
        ...
        values('$Farm','$Flock','Diesel','Diesel','$qnty_of_dsl','$tp','$e_Date')" ;
        
 $confirm_status = mysqli_query($conn,$Query);
       if($confirm_status)
       {
        header("location:desiel_exp.php");
    }
    else
    {
        ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="box box-default">
        ...
        <!-- /.box-header -->
        <div class="box-body">
            <form action="#" method="post" class="was-validated" name="form" enctype="multipart/form-data">
          <div class="row">
            <div class="col-md-6">
              ...
              <?php 
                $q="SELECT IFNULL(SUM(remaining),0)AS Q FROM purchase WHERE name='Diesel' AND type='Diesel'";
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Desiel Expences Record</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body" style="overflow-x: scroll;">
              <table id="example"class="table table-striped table-bordered" cellspacing="0" width="100%">
                ...
                <tbody>
                  <?php
                    $query = "SELECT *,(SELECT Flock_name FROM flock WHERE flock.flock_id=expences.flock_id)AS flk_id,(SELECT name FROM farm WHERE farm.farm_id=expences.farm_id)AS frm_id FROM expences WHERE e_name='Diesel' ";
                    $result = mysqli_query($conn,$query);
