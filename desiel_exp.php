 ...
 if(isset($_REQUEST['BtnSubmit']))
    {
      ...
      $Farm=$_REQUEST['Farm'];
        ...
        $q1="SELECT desiel.id,desiel.remaining,desiel.price FROM desiel WHERE desiel.remaining>0 ORDER BY id ASC";
        ...
        while($row1=mysqli_fetch_array($result1))
        {
          ...
          elseif($GLOBALS['Qty']>=$d_q)
          {
            ...
            $qry2="UPDATE desiel SET desiel.remaining=0 WHERE desiel.id='$d_id'";
          ...
          elseif($GLOBALS['Qty']<$d_q && $GLOBALS['Qty']>0 )
          {
            ...
            $GLOBALS['Qty']=0;
            $qry2="UPDATE desiel SET desiel.remaining='$Qnty' WHERE desiel.id='$d_id'";
            mysqli_query($conn,$qry2);
          }
        }
        $tp=$GLOBALS['Price'];
          ...
          <div class="box">
            ...
            <div class="box-body" style="overflow: scroll;">
              <table id="example"class="table table-striped table-bordered" cellspacing="0" width="100%">
                ...
                <tbody>
                  <?php
                    $query = "SELECT * FROM expences WHERE e_name='Desiel' ";
                    $result = mysqli_query($conn,$query);
