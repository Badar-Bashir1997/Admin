<?php 
 ...
 if(isset($_REQUEST['BtnSubmit']))
 {
      ...
      move_uploaded_file($_FILES["image"]["tmp_name"],"upload/brokers/" . $newFilename);
      $location = "upload/brokers/" . $newFilename;
        ...
        $Query = "INSERT INTO broker(name,phone_no,id_card,Address,bank_name,account_number,balance,remaining,image) 
...
<form action="#" method="post" class="was-validated" enctype="multipart/form-data">
      ...
      <div class="box box-default">
        <div class="box-header with-border">
          <h3 class="box-title">Add New Brokers</h3>
